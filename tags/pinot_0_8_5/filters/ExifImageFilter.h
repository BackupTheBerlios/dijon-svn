...
#ifndef _DIJON_EXIFIMAGEFILTER_H
#define _DIJON_EXIFIMAGEFILTER_H
...
namespace Dijon
{
    class ExifImageFilter : public Filter
    {
    public:
    ...
    private:
	/// ExifImageFilter objects cannot be copied.
	ExifImageFilter(const ExifImageFilter &other);
	/// ExifImageFilter objects cannot be copied.
	ExifImageFilter& operator=(const ExifImageFilter& other);

    };
}

#endif // _DIJON_EXIFIMAGEFILTER_H
